...
namespace IBM.Watson.Examples
{
    public class ExampleToneAnalyzerV3 : MonoBehaviour
    {
        ...
        private string stringToTestTone = "Sorry to hear that.";//"This service enables people to discover and understand, and revise the impact of tone in their content. It uses linguistic analysis to detect and interpret emotional, social, and language cues found in text.";
